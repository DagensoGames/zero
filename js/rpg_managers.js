...
var $dataPokemonMoveset      = null;
var $dataAbilities    = null;
var $dataNature       = null;
var $dataTablaTipos   = null;
var $dataGeneralVariables = null;
var $dataMisiones     = null;
var $dataSkills       = null;
var $dataItems        = null;
var $dataItemsCat     = null;
...
DataManager._databaseFiles = [
    ...
    { name: '$dataPokemon',      src: 'Pokemon.json'      },
    { name: '$dataAbilities',    src: 'abilities.json'    },
    { name: '$dataPokemonMoveset',      src: 'PokemonMoveset.json'      },
    { name: '$dataNature',       src: 'Nature.json'       },
    { name: '$dataTablaTipos',   src: 'TablaTipos.json'   },
    { name: '$dataClasses',      src: 'Classes.json'      },
    { name: '$dataMisiones',     src: 'Misiones.json'     },
    { name: '$dataSkills',       src: 'Skills.json'       },
    { name: '$dataItems',        src: 'Items.json'        },
    { name: '$dataItemsCat',     src: 'itemsCat.json'        },
    ...
    { name: '$dataGeneralVariables', src:'GeneralVariables.json'},
];
...
DataManager.loadSavefileImages = function(info) {
    if (info.characters) {
        for (var i = 1; i < info.characters.length; i++) {
            ImageManager.reserveCharacter(info.characters[i][0]);
        }
    }
    if (info.faces) {
        for (var j = 1; j < info.faces.length; j++) {
...
ImageManager.loadPokemonSprite = function(filename, hue) {
    return this.loadBitmap('img/pokemon/', filename, hue, false);
};
...
ImageManager.loadBattler = function(filename, hue) {
    return this.loadBitmap('img/battler/', filename, hue, true);
};

ImageManager.loadProfileHUD = function(filename, hue) {
    return this.loadBitmap('img/pictures/profile/', filename, hue, true);
};
...
ImageManager.reservePokemonSprite = function(filename, hue, reservationId) {
    return this.reserveBitmap('img/pokemon/', filename, hue, false, reservationId);
};
...
ImageManager.requestPokemonSprite = function(filename, hue) {
    return this.requestBitmap('img/pokemon/', filename, hue, false);
};
