 ...
 *
 *   /img/SumRndmDde/5generation/
 *
 * Within this folder, you need a folder for each section, for example:
 *
 *   /img/SumRndmDde/5generation/Body/
 *   /img/SumRndmDde/5generation/Mouth/
 *   /img/SumRndmDde/5generation/Nose/
 *   /img/SumRndmDde/5generation/Glasses/
 *   etc...
 *
...
_.path = 'img/SumRndmDde/5generation/';
...
_.loadImage = function(filename, hue) {
	...
	if(!bitmap) {
		bitmap = ImageManager.loadBitmap('img/SumRndmDde/5generation/', filename, hue, true);
...
_.checkFileExists = function() {
	FileManager.checkDataExists("CharacterCreator.json", `{
		"Body":{"label":"","direction":0,"source":"Face","color":false,"condition":"true","colors":[["White",23,0.8,0.84,1],["Tan",0,0.8,0],["Brown",24,-1,0.5],["Black",24,-1,0.3],["Gray",24,0,0,0.35],["Salmon",16,0.89,0.85,1]]},
		...
		"Mouth":{"label":"","direction":0,"source":"Face","color":false,"condition":"true","colors":[["White",0],["Tan",0,0.8,0],["Brown",24,-1,0.5],["Negro",24,-1,0.3],["Gray",24,0,0,0.35],["Blue",0,0,0.5,0.5]]},
